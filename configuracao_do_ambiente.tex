...
\begin{enumerate}
    ...
    \item \textbf{Editor de texto ou IDE:} 
        ...
        \footnotesize Eu pessoalmente recomendo a utilização do Neovim, que 
        apesar de ser uma ferramenta de difícil utilização, pode aumentar 
        muito a sua produtividade a médio/longo prazo.
\end{enumerate}
