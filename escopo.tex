...
utilizada em um projeto real, como para controlar a vida do personagem em um jogo:
...
longo do jogo. É notável também que, ao contrário das variáveis locais, uma variável 
global mantém seu valor durante toda a execução do programa.
