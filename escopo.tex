...
conhecida como \texttt{data}, enquanto todas as outras variáveis, com exceção 
das variáveis globais comuns que aprendemos a declarar até agora são alocadas 
em uma área conhecida como \texttt{stack}. Por isso, as variáveis \texttt{static} 
são inicializadas com o valor \(0\) por padrão, a menos que o usuário as inicialize 
explicitamente com um valor diferente.
