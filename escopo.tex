...
Variáveis locais são aquelas que só podem ser acessadas dentro de uma função 
ou bloco de código específico. Em outras palavras, uma vez declaradas dentro 
de uma função, elas não podem ser utilizadas ou modificadas em outros 
contextos, e deixam de existir ao término da função.
\\\\
...
funções do programa, o que simplifica o controle do estado do personagem ao 
...
Ao compilar e executar o código o código acima você vai notar que a variável 
\(y\) terá um valor aleatório, enquanto a variável \(x\) sempre terá o valor 0. 
...
\begin{ps}
    ...
    conceitos serão discutidos com mais detalhes no capítulo % TODO...
\end{ps}
...
% TODO: Elaborar código para exemplicar o uso de variáveis globais static

% TODO: Elaborar código para exemplicar o uso de funções static

\textbf{É de extrema importância que você realize os exercícios aqui elaborados para fixar o conteúdo.}

\begin{enumerate}
    \item Escreva um programa em C que declare duas variáveis com o mesmo 
        nome, uma global e uma local dentro de uma função que não seja a 
