...
\begin{postscript}
    Para converter o tamanho de bits para bytes, basta dividir o valor do tamanho em bits por 8.
\end{postscript}
...
neste caso, uma \textbf{float}. O segundo (\textbf{\&x}) é onde queremos 
...
necessário utilizar o formatador \%f.
