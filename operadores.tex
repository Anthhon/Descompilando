...
\begin{ps}
    O operador de módulo realiza uma divisão entre os números e retorna o quociente da operação.
\end{ps}
...
\begin{ps}
    ...
    \begin{enumerate}
        \item{\textbf{AND lógico:} Retorna verdadeiro no caso de ambos os 
            valores serem verdadeiros, caso contrário, retorna falso.}
        ...
        \item{\textbf{OR lógico:} Retorna verdadeiro se pelo menos um dos 
            valores for verdadeiro, caso contrário, retorna falso.}
