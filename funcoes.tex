...
\begin{enumerate}
    ...
    \item{Tente alterar os valores passados para a função soma para caracteres ou símbolos (`c', `\$', etc.) e analise o comportamento do código.}
    \item{Modifique a função de maneira que seja possível somar 3 valores ao invés de 2.}
    \item{Elabore mais 3 funções que seja possível realizar operações de subtração, multiplicação, divisão e tente utilizá-las ao invés da função soma.}
\end{enumerate}
