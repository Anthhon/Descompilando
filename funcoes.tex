...
Neste exemplo, a função \textbf{soma} recebe dois argumentos inteiros e 
retorna a soma deles. No \textbf{main}, chamamos essa função com os 
argumentos \(3\) e \(4\), atribuindo o resultado à variável "resultado", 
